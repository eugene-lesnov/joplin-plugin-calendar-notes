  ...
  return `
		<div class="calendar-root">
			...
			<div class="calendar-actions">
				...
				<button class="refresh-button" data-action="refresh" title="${escapeHtml(strings.refreshCalendarTitle)}" aria-label="${escapeHtml(strings.refreshCalendarTitle)}">
					<svg class="refresh-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
